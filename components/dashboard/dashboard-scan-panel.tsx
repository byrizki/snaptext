...
export function DashboardScanPanel({
  ...
  return (
    <div className="flex-1 flex flex-col items-center py-6 md:pb-12 overflow-hidden relative">
      <motion.div
      ...
      >
        <motion.div variants={itemVariants} className="flex flex-col items-center gap-3 w-full text-center">
          <h1 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">
            Start a New Scan
          </h1>
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            Upload your document and extract structured data instantly.
          </p>
        </motion.div>
